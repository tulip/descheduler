...
func (x *DeschedulerConfiguration) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		yyv39 := &x.MaxNoOfPodsToEvictPerNode
		yym40 := z.DecBinary()
		_ = yym40
		if false {
		} else {
			*((*int)(yyv39)) = int(r.DecodeInt(codecSelferBitsize1234))
		}
	}
	yyj24++
	if yyhl24 {
